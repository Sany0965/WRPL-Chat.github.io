...
async function loadChat() {
  try {
    ...
    if (saved) {
      ...
      const welcomeText = `
<h2>Привет! Я нейросеть WRPL🙂</h2>
<p>Вот что я могу:</p>
<ul>
<li>Отвечать на вопросы.</li>
<li>Генерировать фото (напиши "сгенерируй фото кота").</li>
<li>Генерировать голос (напиши "гс сколько лет солнцу").</li>
</ul>
<p>Меня создал <a href="https://t.me/worpli" target="_blank" rel="noopener noreferrer">tg: @worpli</a>.</p>
`;
